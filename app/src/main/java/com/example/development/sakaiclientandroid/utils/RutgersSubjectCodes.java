...
//
//
//    public static int getResourceIdFromSubjectCode(int subjectInt, String myPackage, Context context) {
//
//        String iconName;
//        switch(subjectInt) {
//            case 80:
...
//
//        try {
//            int id = context.getResources().getIdentifier(iconName, "drawable", myPackage);
//            return id;
//        }
//        catch(Exception e) {
//            e.printStackTrace();
